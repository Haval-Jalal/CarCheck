const en = {
  ...
  landing: {
    ...
    trust2: '12 check points per car',
    trust3: 'Unlimited for car dealers',
  ...
  auth: {
    ...
    verifyEmail: {
      ...
      successBody: 'Your account is activated and you have received 5 free searches. Log in to get started.',
