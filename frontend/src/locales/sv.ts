const sv = {
  ...
  landing: {
    ...
    trust2: '12 kontrollpunkter per bil',
    trust3: 'Obegränsat för bilhandlare',
  ...
  auth: {
    ...
    verifyEmail: {
      ...
      successBody: 'Ditt konto är aktiverat och du har fått 5 gratis sökningar. Logga in för att komma igång.',
  ...
  billing: {
    ...
    businessTitle: 'Business — Obegränsat + Bulksökning',
    businessSub: 'För bilhandlare och verkstäder',
    businessFeatures: [
      'Obegränsade bilsökningar',
      'Bulksökning — upp till 50 bilar på en gång',
      'Professionella utskriftsrapporter per bil',
      'Perfekt för bilhandlare och verkstäder',
    ],
    subscribeBusiness: 'Kom igång med Business',
    toast: {
      creditsAdded: 'tillagda på ditt konto!',
      credit: 'sökning',
      credits: 'sökningar',
      monthlyActive: 'Månadsplanen är nu aktiv — obegränsade sökningar!',
      businessActive: 'Business-planen är nu aktiv!',
      canceled: 'Betalningen avbröts.',
      cancelSuccess: 'Abonnemanget avbrutet',
  ...
  history: {
    ...
    deleteSuccess: 'Sökning borttagen',
  ...
  favorites: {
    ...
    unknownCar: 'Okänd bil',
    removeSuccess: 'Favorit borttagen',
