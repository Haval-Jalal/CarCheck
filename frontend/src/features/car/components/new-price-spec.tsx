  ...
  return (
    <div className="rounded-xl border border-border bg-card p-6 space-y-5">
      ...
      <p className="text-xs text-muted-foreground/60 italic">
        Nypriset är ett ungefärligt ursprungligt listpris för {brand} {model} {year} på svenska marknaden.
        Faktiskt pris vid köp varierade beroende på extrautrustning och förhandling.
      </p>
    </div>
  )
}
